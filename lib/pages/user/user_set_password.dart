      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Text("请设置您的支付密码", style: TextStyle(color: Color(0xff888888), fontSize: ScreenAdapterUtils.setSp(17),),),
          ),
          Container(
            ...
            child: Container(
              ...
              child: FlatButton(
                onPressed: pwdData.length == 6?
                  (){
                    AppRouter.push(context, RouteName.USER_SET_PASSWORD_AGAIN, arguments: UserSetPasswordAgain.setArguments(pwdData));
                  }
                  :null,
                ...
                child: Container(
                  ...
                  child: Text('下一步', style: TextStyle(fontSize: ScreenAdapterUtils.setSp(17),color: Colors.white ),),
                ),
              ),
              // child: Container(
              //   alignment: Alignment.center,
