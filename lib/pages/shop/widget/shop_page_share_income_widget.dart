...
class ShopPageShareIncomeWidget extends StatefulWidget {
  ShopPageShareIncomeWidget({Key key}) : super(key: key);

  @override
  _ShopPageShareIncomeWidgetState createState() => _ShopPageShareIncomeWidgetState();
}

class _ShopPageShareIncomeWidgetState extends ShopPageIncomeWidgetState<ShopPageShareIncomeWidget> {
  ...
  _getIncomeDetail() async {
    ResultData resultData = await HttpManager.post(ShopApi.shop_share_income, {
