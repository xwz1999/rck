...
class _ShopCommissionInfoPageState
    extends BaseStoreState<ShopCommissionInfoPage> {
    ...
    return Scaffold(
      ...
      body: _model == null
          ...
          : RefreshWidget(
              ...
              onLoadMore:
                  _listData == null || _listData.length < (_page + 1) * 20
                      ? null
                      : () {
                          _page++;
                          _getIncomeSalesList();
