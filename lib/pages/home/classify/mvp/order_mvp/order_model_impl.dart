...
class OrderModelImpl extends OrderModelI {
  ...
  Future<ResultData> submitOrder(int orderPreviewId, int userId) async {
    ResultData resultData = await HttpManager.post(
        OrderApi.order_normal_submit, {"userId": userId, "previewOrderId": orderPreviewId});
    return resultData;
  }
  ...
  @override
  Future<ResultData> changeAddress(int userId, int orderId, int addressId) async {
    ResultData resultData = await HttpManager.post(OrderApi.order_change_address,
  ...
  Future<ResultData> changeShippingMethod(
    ...
    ResultData resultData = await HttpManager.post(OrderApi.order_change_shipping_method, {
      "userId": userId,
      "orderId": orderId,
  ...
  Future<ResultData> getStoreList() async {
    ResultData resultData = await HttpManager.post(OrderApi.order_store_list, {});
    return resultData;
  }

  @override
  Future<ResultData> changeBuyerMessage(int userId, int orderId, String message) async {
    ResultData resultData = await HttpManager.post(OrderApi.order_change_buyer_message,
  ...
  Future<ResultData> createAliPayOrder(int userId, int orderId) async {
    ResultData resultData = await HttpManager.post(
        OrderApi.order_alipay_order_create, {"userId": userId, "orderId": orderId});
    return resultData;
  }
  ...
  Future<ResultData> createWeChatOrder(int userId, int orderId) async {
    ResultData resultData = await HttpManager.post(
        OrderApi.order_wechat_order_create, {"userId": userId, "orderId": orderId});
    return resultData;
  }
  ...
  Future<ResultData> verifyOrderPayStatus(int orderId) async {
    ResultData resultData =
        await HttpManager.post(OrderApi.order_verify_pay_status, {"orderId": orderId});
    return resultData;
  }
  ...
  queryRecookPayFund(int userId) async {
    ResultData resultData =
        await HttpManager.post(OrderApi.order_query_recook_pay_fund, {"userId": userId});
    return resultData;
  }
  ...
  createRecookPayOrder(int userId, int orderId, String password) async {
    ResultData resultData = await HttpManager.post(
        OrderApi.order_recook_pay_order_create, {"userId": userId, "orderId": orderId, 'password': password});
    return resultData;
  }
