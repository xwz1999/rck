...
const double _hkToolbarHeight = kToolbarHeight;
const double _kLeadingWidth =
    _hkToolbarHeight; // So the leading button is square.
...
class _ToolbarContainerLayout extends SingleChildLayoutDelegate {
  ...
  BoxConstraints getConstraintsForChild(BoxConstraints constraints) {
    return constraints.tighten(height: _hkToolbarHeight);
  }

  @override
  Size getSize(BoxConstraints constraints) {
    return Size(constraints.maxWidth, _hkToolbarHeight);
  }
  ...
  AppBar({
    ...
    this.bottomOpacity = 1.0,
        ...
        preferredSize = Size.fromHeight(
            _hkToolbarHeight + (bottom?.preferredSize?.height ?? 0.0)),
        super(key: key);
        ...
        children: <Widget>[
          Flexible(
            child: ConstrainedBox(
              constraints: const BoxConstraints(maxHeight: _hkToolbarHeight),
              child: appBar,
            ),
          ),
...
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  ...
  double get minExtent =>
      collapsedHeight ?? (topPadding + _hkToolbarHeight + _bottomHeight);

  @override
  double get maxExtent => math.max(
      topPadding + (expandedHeight ?? _hkToolbarHeight + _bottomHeight),
      minExtent);
  ...
  Widget build(
    ...
    final double toolbarOpacity = !pinned || (floating && bottom != null)
        ? ((visibleMainHeight - _bottomHeight) / _hkToolbarHeight)
            .clamp(0.0, 1.0)
        : 1.0;
