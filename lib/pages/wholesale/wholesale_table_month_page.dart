...
import 'package:jingyaoyun/pages/wholesale/wholesale_table_day_page.dart';
...
class WholesaleTableMonthPage extends StatefulWidget {
  final int year;
  ...
  @override
  _WholesaleTableMonthPageState createState() => _WholesaleTableMonthPageState();
}

class _WholesaleTableMonthPageState extends State<WholesaleTableMonthPage> {
  ...
  void initState() {
    ...
    _date = DateTime(widget.year,1,1);
  }
    ...
    return ImageScaffold(
      ...
      body: Flexible(
        child:                   RefreshWidget(
            ...
            color: Colors.white,
            onRefresh: () async {
              models = await UserBenefitFunc.getPiFaTable(2,
                  start: DateTime(_date.year,1,1)
                  ,end: DateTime(_date.year+1,1,1));
