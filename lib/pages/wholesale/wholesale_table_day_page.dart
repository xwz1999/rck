...
class WholesaleTableDayPage extends StatefulWidget {
  ...
  @override
  _WholesaleTableDayPageState createState() => _WholesaleTableDayPageState();
}

class _WholesaleTableDayPageState extends State<WholesaleTableDayPage> {
  ...
  void initState() {
    super.initState();
    _date = DateTime(widget.year,widget.month,1);
  }
