...
Data _$DataFromJson(Map<String, dynamic> json) {
  return Data(
    ...
    (json['mainPhotos'] as List?)
        ?.map((e) =>
          MainPhotos.fromJson(e as Map<String, dynamic>))
        .toList(),
    (json['attributes'] as List?)
        ?.map((e) =>
            Attributes.fromJson(e as Map<String, dynamic>))
        .toList(),
    (json['sku'] as List?)
    ...
    (json['coupons'] as List?)
        ?.map((e) =>
          Coupons.fromJson(e as Map<String, dynamic>))
        .toList(),
    json['isFavorite'] as bool?,
    json['shoppingTrolleyCount'] as int?,
    (json['recommends'] as List?)
        ?.map((e) =>
            Recommends.fromJson(e as Map<String, dynamic>))
        .toList(),
    json['isImport'],
    json['isFerme'],
...
Evaluations _$EvaluationsFromJson(Map<String, dynamic> json) {
  return Evaluations(
      ...
      (json['children'] as List?)
          ?.map((e) =>
              Evaluation.fromJson(e as Map<String, dynamic>))
          .toList());
}
